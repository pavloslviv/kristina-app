<?php
/**
 * The template for displaying all single deal posts.
 *
...
get_header(); ?>
	...
	$sidebar = get_post_meta( $the_id, 'opendept_deal_sidebar_enable_sidebar', true );
	$grey_box = get_post_meta( $the_id, 'opendept_deal_sidebar_enable_box', true );
	$grey_box_title = get_post_meta( $the_id, 'opendept_deal_sidebar_box_title', true );
	$grey_box_price = get_post_meta( $the_id, 'opendept_deal_sidebar_box_price_date', true );
	$grey_box_price_per = get_post_meta( $the_id, 'opendept_deal_sidebar_box_price_per_m_y', true );
	$grey_box_button_text = get_post_meta( $the_id, 'opendept_deal_sidebar_box_button_text', true );
	$grey_box_button_link = get_post_meta( $the_id, 'opendept_deal_sidebar_box_button_link', true );
	$grey_box_button_color = get_post_meta( $the_id, 'opendept_deal_sidebar_box_button_color', true );
	$grey_box_button_target = get_post_meta( $the_id, 'opendept_deal_sidebar_box_button_target', true );
	$grey_box_notes = get_post_meta( $the_id, 'opendept_deal_sidebar_box_notes', true );
	$sidebar_content = get_post_meta( $the_id, 'opendept_deal_sidebar_content', true );
			...
			<div class="column<?php echo $col_class; ?>">
				...
				<div id="primary" class="content-area">
					...
					while ( have_posts() ) : the_post();
						...
						if ( true == get_theme_mod( 'enable_deal_comments', false ) ) :
