...
<div class="hemma-icons-inline">
	<?php get_template_part( 'icons/inline', 'icons.svg' ); ?>
</div><!-- /.hemma-icons-inline -->
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'hemma' ); ?></a>
